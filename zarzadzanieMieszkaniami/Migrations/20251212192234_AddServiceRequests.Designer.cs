...
namespace zarzadzanieMieszkaniami.Migrations
{
    ...
    [Migration("20251212192234_AddServiceRequests")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Models.ServiceRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("IssueId", "ServicemanId")
                        .IsUnique()
            ...
            modelBuilder.Entity("Core.Models.UserNote", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("p_k_user_notes");

                    b.HasIndex("TargetUserId")
                        .HasDatabaseName("i_x_user_notes_target_user_id");

                    b.HasIndex("OwnerId", "TargetUserId")
                        .IsUnique();

                    b.ToTable("user_notes");
                });
            ...
            modelBuilder.Entity("Core.Models.ServiceRequest", b =>
                {
                    b.HasOne("Core.Models.Issue", "Issue")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("f_k_service_requests_issues_issue_id");

                    b.HasOne("Core.Models.User", "Landlord")
                        .WithMany("ServiceRequestsSent")
                        .HasForeignKey("LandlordId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Core.Models.User", "Serviceman")
                        .WithMany("ServiceRequestsReceived")
                        .HasForeignKey("ServicemanId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Core.Models.UserNote", b =>
                {
                    b.HasOne("Core.Models.User", "Owner")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("f_k_user_notes_asp_net_users_owner_id");
                    ...
                    b.HasOne("Core.Models.User", "TargetUser")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("f_k_user_notes_asp_net_users_target_user_id");
            ...
            modelBuilder.Entity("Core.Models.User", b =>
                {
                    ...
                    b.Navigation("ServiceRequestsReceived");

                    b.Navigation("ServiceRequestsSent");
